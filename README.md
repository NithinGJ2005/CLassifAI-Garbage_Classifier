# ♻️**ClassifAI - A Garbage Classifier App**   
...
✅ **Lightweight Deployment** – Easily deployable on [Streamlit Cloud]([https://garbage-classifier-ai.streamlit.app/](https://classif-ai-a-garbage-classifier-app.streamlit.app/)).
